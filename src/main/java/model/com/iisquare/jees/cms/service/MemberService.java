...
import com.iisquare.jees.cms.dao.DutyDao;
import com.iisquare.jees.cms.dao.MemberDao;
import com.iisquare.jees.cms.dao.MemberOrganizeRelDao;
import com.iisquare.jees.cms.dao.MemberRoleRelDao;
import com.iisquare.jees.cms.dao.OrganizeDao;
import com.iisquare.jees.cms.dao.RoleDao;
import com.iisquare.jees.cms.domain.Member;
import com.iisquare.jees.cms.domain.MemberOrganizeRel;
import com.iisquare.jees.cms.domain.MemberRoleRel;
...
public class MemberService extends CoreService {
	...
	public String formatRoleRelText(List<Map<String, Object>> list) {
		...
		for (Map<String, Object> map : list) {
			Object roleRelInfo = map.get("role_id_info");
			if(DPUtil.empty(roleRelInfo)) continue ;
			returnList.add(((Map<String, Object>) roleRelInfo).get("name"));
		}
		return DPUtil.implode(",", DPUtil.collectionToArray(returnList));
	}
