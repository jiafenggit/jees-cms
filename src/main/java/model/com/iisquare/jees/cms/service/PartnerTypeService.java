...
@Service
public class PartnerTypeService extends ServiceBase {
	...
	public List<Map<String, Object>> getList(String columns, String orderBy, int page, int pageSize) {
		...
		List<Map<String, Object>> list = partnerTypeDao.getList(columns, null, new Object[]{}, append, page, pageSize);
	...
	public PartnerType getById(Object id) {
		return partnerTypeDao.getById(id);
	}
	
	public Map<String, Object> getById(Object id, boolean bFill) {
		Map<String, Object> map = partnerTypeDao.getById("*", id);
		if(null != map && bFill) {
	...
	public int update(PartnerType persist) {
		return partnerTypeDao.update(persist);
	}
